...
public class SecondarySort {
	...
	public static class IntPair implements WritableComparable<IntPair> {
		...
		public static class Comparator extends WritableComparator {
			...
			/** 使用下面的方法，要在上面的构造方法中调用父类的单参数构造方法 */
			/*public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2,
					int l2) {
				return compareBytes(b1, s1, l1, b2, s2, l2);
			}*/
			
			/** 使用下面的方法，要在上面的构造方法中调用父类的双参数构造方法，且第二个参数为true */
			public int compare(IntPair w1, IntPair w2){
		...
		/** 下面的静态方法作用和 job.setSortComparatorClass(IntPair.Comparator.class); 一样 */
	...
	public static void main(String[] args) throws Exception {
		...
		job.setSortComparatorClass(IntPair.Comparator.class);
